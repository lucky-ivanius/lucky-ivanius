...
<section
	id="home"
	class="mx-auto mt-16 flex w-full scroll-mt-32 flex-col items-start justify-center xl:mt-8"
>
	<div class="container mx-auto flex flex-col items-center px-6 text-left lg:flex-row">
		<div class="flex w-full flex-col items-center justify-center space-y-8 lg:items-start xl:w-1/2">
			<p class="text-4xl font-semibold text-blue-700">Hi 👋</p>
			<h1 class="text-6xl font-black">I'm Lucky Ivanius.</h1>
			<p class="text-foreground/60 text-2xl font-medium">
				Self-taught software engineer who is super passionate about building scalable systems.
				Specializes in back-end development and loves diving deep into complex technical challenges.
			</p>
			<div class="grid grid-cols-2 space-x-4">
				<a
					href="https://linkedin.com/in/lucky-ivanius"
				...
				<a
					href="https://github.com/lucky-ivanius"
					class="transition-transform duration-300 hover:-translate-y-1.5"
					target="_blank"
					aria-label="GitHub"
				>
		...
		<div class="flex h-[70dvh] w-full items-center justify-center xl:ml-12 xl:w-1/2">
			<img src="/images/me.png" alt="Lucky Ivanius" class="h-full w-full object-contain" />
		</div>
	</div>
</section>
